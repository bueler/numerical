...
\wkday{8}{3/4}{3/8}     & cont. & QM axioms \par \due{Assignment 4 due} & 3.1 \\ \hline

\wkday{9}{3/11}{3/15}   & \vac{Spring Break} & \vac{Spring Break} & \vac{Spring Break} \\ \hline

\wkday{10}{3/18}{3/22}  & cont. & \ee{Midterm Quiz} & 3.2, 3.3, 3.4, 3.5 \\ \hline

\wkday{11}{3/25}{3/29}  & 4.1, 4.2, 4.3, 4.4, 5.1 & 5.2 & \phantom{x} \par \dl{withdraw} \\ \hline
