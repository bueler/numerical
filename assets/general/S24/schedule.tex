...
\begin{document}
\hfill \small \emph{version 0.2: \today} \normalsize
...
\wkday{1}{1/15}{1/19}   & \vac{AK Civil Rights Day} & 2.1,2.2,2.4 & handout \\ \hline

\wkday{2}{1/22}{1/26}   & & 2.4,2.6,2.7 & \phantom{x} \par \dl{add/drop} \\ \hline
