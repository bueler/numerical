...
\lhead{\large\sf\textbf{Syllabus MATH F617 {\color{red} (revised 2/26)}}}
...
{\color{red} \textbf{\emph{Revised 2/26.}}}

\begin{tabular}{|l|l|r|}
\hline
Homework & nearly weekly & {\color{red} 55\%} \\
\hline
{\color{red} Midterm Quiz} & {\color{red} in-class Wednesday March 20} & {\color{red} 20\%}  \\
\hline
Final Exam   & in-class Friday May 3 & {\color{red} 25\%} \\
\hline
total & & 100\% \\
\hline
\end{tabular}
